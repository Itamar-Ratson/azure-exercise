...
SVC_NAME=`systemd-escape --path "vsts.agent.ItamarRatson.SelfHostedPool.ubuntu-agent.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (ItamarRatson.SelfHostedPool.ubuntu-agent)"
